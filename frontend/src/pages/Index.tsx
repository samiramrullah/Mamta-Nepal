                        ...
                        <div className="w-full px-4 lg:w-2/5">
                            <div className=" lg:max-w-xl">
                                ...
                                <h1 className="mb-6 text-6xl font-bold dark:text-gray-300 lg:text-6xl">
                                    {/* <span className=" " style={{ color: '#ff0532' }} >Develop</span> */}
                                    <span className="pl-10 text-red-600" >Motherhood</span>
                                </h1>
                                ...
                                <a className="inline-block w-full px-6 py-4 mb-2 text-lg font-medium leading-6 text-center text-white transition duration-200 bg-red-400 rounded shadow dark:bg-blue-500 dark:hover:bg-blue-700 md:w-auto md:mb-0 md:mr-4 hover:bg-blue-700"
                                    href="#">
                                    Request a demo
                                </a>
                            </div>
                            ...
                            <div className="flex justify-center lg:justify-end">
                                ...
                                <div>
                                    <img className="block object-cover w-full h-32 mx-auto mb-8 rounded-md sm:h-64"
                                        ...
                                        " alt="" />
                                    <img className="block object-cover w-full h-32 mx-auto mb-8 rounded-md sm:h-64"
                                        src="https://img.freepik.com/premium-vector/beautiful-illustration-father-mother-with-daughter_96037-102.jpg?w=1480" alt="" />
                                </div>
                            </div>
                        </div>
