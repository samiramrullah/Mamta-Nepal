      ...
      <footer className="w-full py-4 " style={{backgroundColor:'#fff8f8'}}>
        <div className="md:px-12 lg:px-28">
          <div className="container m-auto space-y-6 text-gray-600 dark:text-gray-300">
            <img src="https://tailus.io/sources/blocks/product-website/preview/images/logo.svg" alt="logo tailus" className="m-auto w-40" />
            <ul
            ...
            <div className="m-auto flex w-max items-center justify-between space-x-4">
              ...
              <a href="n" title="facebook" target="blank" aria-label="facebook">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="currentColor"
                  className="m-auto w-5"
              ...
              <a href="hjk" title="linkedin" target="blank" aria-label="linkedin">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="currentColor"
                  className="m-auto w-5"
            ...
            <div className="text-center">
              ...
              >Copyright © MamtaNepal <span id="year"></span> | All right reserved</span
              >
            </div>
          </div>
        </div>
